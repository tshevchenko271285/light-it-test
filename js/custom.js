...
Vue.component('list-item', {
	...
	<div class="music-item">
		<div v-on:click="opened" class="music-item_header">
			<div class="music-item_image">
				<img 
					:src="item.сollectionImage" 
		...
		<div v-if="item.open" class="music-item_body">
			<div class="music-item_image">
				<img 
					:src="item.сollectionImage" 
					:alt="item.collectionName"
					class="d-inline d-lg-none img-fluid"
				>
			</div>
...
new Vue ({
	el: '#music',
	data: {
		searchString: '', // SEARCH INPUT FIELD
		list: [], // LIST OF SONGS
		timeout: '', // PREVENT UNNECESSARY REQUESTS
	},
	watch: {
		// WATCHING THE SEARCH FORM
